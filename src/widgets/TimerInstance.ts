...
export interface TimerInstance {
    ...
    timerTargetId?: string;    // Stable target ID shared across inline/frontmatter
    autoGeneratedTargetId?: boolean; // True when plugin-generated temporary timer target ID
    startTime: Date;
