...
### 期間の計算
タスクの期間は、
1. SED、SE型は、startからendまでの期間を計算する
2. SD、S-All型は、end = start とみなす（1日幅）
3. S-Timed型はstart+1hourをendとみなす
4. E、ED型は、start = 今日の日付とみなす
5. D型は、start = 今日の日付、end = 今日の日付とみなす（1日幅）
