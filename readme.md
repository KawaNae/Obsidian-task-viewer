## コンセプト
事前コミットメントを主体としたタスク管理システム
- タスクの開始、終了、締め切りを事前に指定
- timer/pomodoro widgetによる開始の明確な宣言
...
子タスクが**時刻のみ**（`HH:mm`形式）を指定した場合、親タスクの`startDate`を自動的に継承する。これにより、同日の準備タスクや片付けタスクを簡潔に記述できる。

```markdown
- [ ] 会議 @2026-01-28T15:45>16:30>2026-01-31
    - [ ] 準備 @14:15>15:45      # → @2026-01-28T14:15>2026-01-28T15:45 として扱う
    - [ ] 片付け @16:30>17:00    # → @2026-01-28T16:30>2026-01-28T17:00 として扱う
    - [ ] 必要なものを準備 @2026-01-27  # 明示的な日付 → そのまま
    - [ ] 報告 @>>2026-01-30     # 明示的なdeadline → そのまま
```

| 子タスク記法 | 実際の解釈 |
|-------------|-----------|
| `@14:15>15:45` | `@{親の日付}T14:15>{親の日付}T15:45` |
| `@10:00` | `@{親の日付}T10:00` |
| `@>17:00` | `@>{親の日付}T17:00` |
