...
import { TaskPropertyResolver } from '../../../src/services/parsing/TaskPropertyResolver';
...
describe('TaskPropertyResolver', () => {
    it('single-level: child inherits parent properties', () => {
        ...
        TaskPropertyResolver.resolve([parent, child]);
    ...
    it('multi-level: grandparent → parent → child cascade', () => {
        ...
        TaskPropertyResolver.resolve([gp, parent, child]);
    ...
    it('root tasks: no change', () => {
        ...
        TaskPropertyResolver.resolve([root]);
    ...
    it('multiple children inherit same parent properties', () => {
        ...
        TaskPropertyResolver.resolve([parent, c1, c2]);
