...
describe('DateResolver', () => {
    ...
    describe('absolute mode', () => {
        it('returns the date as-is', () => {
            const result = DateResolver.resolve('2026-06-15', 1, 0);
    ...
    describe('today', () => {
        it('returns current date', () => {
            const result = DateResolver.resolve({ preset: 'today' }, 1, 0);
    ...
    describe('thisWeek (Monday start)', () => {
        it('returns Monday to Sunday', () => {
            ...
            const result = DateResolver.resolve({ preset: 'thisWeek' }, 1, 0);
    ...
    describe('thisWeek (Sunday start)', () => {
        it('returns Sunday to Saturday', () => {
            ...
            const result = DateResolver.resolve({ preset: 'thisWeek' }, 0, 0);
    ...
    describe('nextWeek', () => {
        it('returns next week bounds (Monday start)', () => {
            ...
            const result = DateResolver.resolve({ preset: 'nextWeek' }, 1, 0);
    ...
    describe('pastWeek', () => {
        it('returns past week bounds (Monday start)', () => {
            ...
            const result = DateResolver.resolve({ preset: 'pastWeek' }, 1, 0);
    ...
    describe('nextNDays', () => {
        it('returns today + n-1 days', () => {
            const result = DateResolver.resolve({ preset: 'nextNDays', n: 7 }, 1, 0);
            expect(result).toEqual({ start: '2026-03-11', end: '2026-03-17' });
        });

        it('defaults to 7 when n is not set', () => {
            const result = DateResolver.resolve({ preset: 'nextNDays' }, 1, 0);
            expect(result).toEqual({ start: '2026-03-11', end: '2026-03-17' });
        });

        it('n=1 means today only', () => {
            const result = DateResolver.resolve({ preset: 'nextNDays', n: 1 }, 1, 0);
            expect(result).toEqual({ start: '2026-03-11', end: '2026-03-11' });
        });
    });
    ...
    describe('thisMonth', () => {
        it('returns month boundaries', () => {
            const result = DateResolver.resolve({ preset: 'thisMonth' }, 1, 0);
    ...
    describe('thisYear', () => {
        it('returns year boundaries', () => {
            const result = DateResolver.resolve({ preset: 'thisYear' }, 1, 0);
    ...
    describe('unknown preset', () => {
        it('falls back to today', () => {
            const result = DateResolver.resolve({ preset: 'unknown' as any }, 1, 0);
            expect(result).toEqual({ start: '2026-03-11', end: '2026-03-11' });
        });
    });
});
